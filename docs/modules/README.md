...
`docs/features.md`, or focused release/version plans. Use them when a change
crosses module boundaries or when a future module-doc agent needs to decide
whether an accepted merge changed a durable design boundary.
...
- Keep feature implementation plans in the active planning docs.
