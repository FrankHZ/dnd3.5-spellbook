...
| `Shield Of Faith, Legion's` | no exact parsed JSON match found                         |
...
`Shield Of Faith, Legion's` needs separate investigation before becoming an
insert or clone operation.
