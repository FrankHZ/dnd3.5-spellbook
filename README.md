...
The active public release plan is **v1.1**. The latest frozen public release is
**v1.0**. The latest frozen pre-release stage snapshot is **v3.10**.
...
- [docs/releases/v1.1/README.md](./docs/releases/v1.1/README.md): active v1.1
  production hardening and full spell corpus plan.
- [docs/releases/v1.0/FREEZE.md](./docs/releases/v1.0/FREEZE.md): latest
